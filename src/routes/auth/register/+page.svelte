<script lang="ts">
	...
	$: ({ name, email, password, error } = form ?? {
		name: '',
		email: '',
		password: '',
		error: ''
...
<svelte:head>
	<title>CodeShare | Create Account</title>
</svelte:head>
...
<section class="container">
	...
	>
		...
		<Button variant="primary" size="large" {disabled}>Finish Creating Your Account</Button>
	</form>
	...
	<div class="link">
		...
		<p class="terms">
			By creating an account, you accept CodeShare's privacy policy and terms of service.
		</p>
	</div>
</section>
